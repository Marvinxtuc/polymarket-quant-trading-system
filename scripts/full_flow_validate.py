...
def main() -> int:
    ...
    parser.add_argument("--monitor-window-seconds", type=int, default=0, help="Use 0 for structural validation without waiting 30m/12h")
    ...
    report = run_full_flow_validation(
        ...
        monitor_window_seconds=int(args.monitor_window_seconds),
